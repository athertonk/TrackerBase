      ...
      Try
        ...
        cmdText = String.Format(<a>
          SELECT PRJ.Objectid  as prjID   
           ...
           , OP.[ContactEmail]   
           , OP.[CountyCode]  
          FROM {0}.{0}.PermissionRoles as PRles       
          INNER JOIN {0}.{0}.Project as PRJ ON PRles.ProjectOid = PRJ.ObjectID       
          INNER JOIN {0}.{0}.ProjectDatum as PD ON PRJ.ObjectID = PD.ProjectId        
          INNER JOIN {0}.{0}.Operation as OP ON PD.ObjectID = OP.ObjectID       
          LEFT OUTER JOIN {0}.{0}.UserRoles as URles ON PRles.RoleID = URles.RoleID       
    ...
    Public Shared Sub TransferProject(ByVal projectId As Long, ByVal transfereeName As String, ByVal addltext As String, _
      ...
      Try
        ...
        emailText = "Dear " & transfereeName & "," & _
          "<br />" & _
          "A Tracker project has been transferred to you from user " & sender.UserName & ". " & _
          "The project should show up on your Project Mgmt page at <a href='tracker.missouri.edu'>tracker.missouri.edu</a> with the name " & project.Name & "." & _
          "<br />" & _
        ...
        emailText = "Hello " & transfereeName & "," & _
          "<br />" & _
          "I've transferred a Tracker project to you. " & _
          "The project should show up on your Project Mgmt page at <a href='tracker.missouri.edu'>tracker.missouri.edu</a> with the name " & project.Name & "." & _
          "<br />" & _
        ...
        If String.IsNullOrWhiteSpace(senderEmail) Then
          ...
          fromAddr = "no-reply@tracker.missouri.edu"
          ccAddr = Nothing
          emailText = "Dear " & transfereeName & "," & _
            "<br />" & _
            "A Tracker project has been transferred to you from user " & sender.UserName & ". " & _
        ...
        localInfo = ""
        CF.SendEmail(toAddr, fromAddr, "Tracker project transfer (" & project.Name & ")", emailText, localInfo, ccAddr)
        If localInfo.ToLower.Contains("error") Then callInfo &= Environment.NewLine & localInfo
