...
Namespace Tracker.Model
  ...
  Public Class ProjectDatumHelper
    ...
    ''' </summary>
    Public Shared Function GetProjectDatumInfoByGuid(ByVal datumGuid As String, ByRef callInfo As String) As Tracker.Model.ProjectDatum
      Dim retVal As Tracker.Model.ProjectDatum = Nothing
      Try
        Using conn As New SqlConnection(dataConn)
          Using cmd As SqlCommand = conn.CreateCommand()
            ...
            While readr.Read
              Try
                retVal = New Tracker.Model.ProjectDatum
                With retVal
