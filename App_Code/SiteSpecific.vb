...
#Region "Site specific"
  ...
  Public Shared ReadOnly Property SiteSubdomain() As String
    Get
      ...
      Dim parts() As String = thisSite.Replace("www.", "").Replace("tracker", "").Split(New Char() {"."c}, StringSplitOptions.RemoveEmptyEntries)
  ...
  Public Shared ReadOnly Property ProjectSchemaName() As String
    Get
      Dim retVal As String = "TrackerBase"
      Return retVal
    End Get
  End Property
  ...
  Public Shared ReadOnly Property BaseDatabaseConnString() As String
    Get
      Dim retVal As String = ConnectionStrings("TrackerBaseDataConnString").ConnectionString
      Return retVal
    End Get
  End Property
  ...
  Public Shared ReadOnly Property ProjectFolderBase() As String
    Get
      Dim retVal As String = "C:\Workdata\TrackerBase\TrackerBaseProjectFolders"
      Return retVal
    End Get
  End Property
