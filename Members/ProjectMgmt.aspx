...
Dear {user},
A Tracker project has been transferred to you from user {sender}. The project should show up on your Project Mgmt page at tracker.missouri.edu with the name {projectname}.
...
If you think you received this project in error, please contact the sender at the cc’ed email address above. You may delete the project using the Tracker tools.
...
Hello {user},
I've transferred a Tracker project to you. 
The project should show up on your Project Mgmt page at tracker.missouri.edu with the name {projectname}.
